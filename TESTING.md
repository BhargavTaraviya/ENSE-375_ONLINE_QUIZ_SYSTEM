...
Here is the [Data Flow Diagram](Documents/Data_Flow_Diagram.pdf)

# Unit Testing
With unit testing, we can test individual classes and their methods in isolation. We test classes including **User**, **UserManager**, **Authentication**, **Question**, **Quiz**, and **QuestionManager**.
